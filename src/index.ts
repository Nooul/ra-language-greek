...
const elMessages: TranslationMessages = {
  ra: {
    ...
    input: {
      ...
      image: {
        upload_several:
          "Τοποθετήστε μερικές εικόνες για μεταφόρτωση ή κάντε κλικ για να επιλέξετε ένα.",
        upload_single:
          "Τοποθετήστε μια εικόνα για μεταφόρτωση ή κάντε κλικ για να το επιλέξετε.",
      },
      password: {
    ...
    message: {
      ...
      bulk_update_content:
        "Είστε σιγουροι ότι θέλετε να ενημερώσετε το %{name}? |||| Είστε σιγουροι ότι θέλετε να ενημερώσετε αυτά τα %{smart_count} αντικείμενα?",
      bulk_update_title:
        "Ενημέρωση %{name} |||| Ενημέρωση %{smart_count} %{name}",
      delete_content: "Σίγουρα θέλετε να το διαγράψετε;",
      delete_title: "Διαγραφή %{name} #%{id}",
      details: "Λεπτομέρειες",
      error: "Ένα λάθος πραγματοποιήθηκε και η αίτηση σας δεν ολοκληρώθηκε.",
      ...
      yes: "Ναι",
      unsaved_changes:
        "Μερικές από τις αλλαγές σας δεν σώθηκαν. Θέλετε να τι αγνοήσετε;",
    },
    navigation: {
